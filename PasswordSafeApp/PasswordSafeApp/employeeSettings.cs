...
INNER JOIN Customers ON Orders.CustomerID = Customers.CustomerID;
            */
            ...
            foreach (DataRow item in d.Rows)
            {
                ...
                dataGridView1.Rows[r].Cells[4].Value = item["username"].ToString();
                dataGridView1.Rows[r].Cells[5].Value = item["password"].ToString();
                dataGridView1.Rows[r].Cells[6].Value = item["privilage"].ToString();
                dataGridView1.Rows[r].Cells[7].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[8].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[9].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[10].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[11].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[12].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[13].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[14].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[15].Value = item["Konum"].ToString();
                dataGridView1.Rows[r].Cells[16].Value = item["Konum"].ToString();
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            var com6 ="INSERT INTO passlogin (ID,username,password,privilage) VALUES('" + textBox1.Text + "'," +
